...
# 1. Setup the Client
client = OpenAI(
    base_url="http://155.210.135.92:8080/v1", 
    api_key="LKSD7sdknAI9dslkdDASDJIW8QWDLK"        
)
...
num_instances = 1  # <-- Number of new iterations you want to generate in this run
...
# FILL ALL THESE VARIABLES IF YOU NEED TO RESUME A INTERRUPTED EXECUTION.
# LEAVE THEM AS None FOR A NORMAL EXECUTION FROM SCRATCH.
resume_from_model_alias = "Llama"  # e.g., "Llama" (Use the Alias here!)
resume_from_temp = 0.2   # e.g., 0.5
resume_from_file = "Curated_Problems_OR.xlsx"   # e.g., "OR_problems_LP_MILP.xlsx"
resume_from_id = 1     # e.g., 2
...
SYSTEM_PROMPT = """
You are an expert in Operational Research and Python programming. 
        ...
        for index, row in df.iterrows():
            ...
            for _ in range(num_instances):
                ...
                try:
                    ...
                    print(f"  -> Timeout: The model took too long. Skipping to the next.")
                    continue
...
if __name__ == "__main__":
    excel_files = ["OR_problems_LP_MILP.xlsx", "IndustryOR_LP_MILP.xlsx", "Curated_Problems_OR.xlsx"]
