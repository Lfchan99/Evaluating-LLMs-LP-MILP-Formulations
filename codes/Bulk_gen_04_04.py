...
# Choose the server here: "pimiento_verde" or "pimiento_rojo"
target_server = "pimiento_rojo" 

servers = {
    "pimiento_verde": {
        "base_url": "http://155.210.135.90:8080/v1",
        "api_key": "QbWoPcS3qQfLiWW8BnR9XIj00ToeJ4OZ"
    },
    "pimiento_rojo": {
...
selected_server = servers[target_server]
...
resume_from_file = "OR_problems_LP_MILP.xlsx"   # e.g., "OR_problems_LP_MILP.xlsx"
resume_from_id = 1200     # e.g., 2
...
if __name__ == "__main__":
    excel_files = ["OR_problems_LP_MILP.xlsx"]
