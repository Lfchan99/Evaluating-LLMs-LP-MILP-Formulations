...
# --- TEST CONFIGURATION ---
target_source_file = "Curated_Problems_OR" # Set to None to process all source files, or specify one like "OR_problems_LP_MILP.xlsx"
start_id = None
end_id = None
start_iter = 1
end_iter = None
        ...
        try:
            ...
            if process.returncode == 0:
                ...
                for line in output_text.split('\n'):
                    ...
                    if clean_line.startswith("OptimalValue:"):
                        try:
                            extracted_optimal_value = float(clean_line.split(':')[1].strip())
                        except ValueError:
                            extracted_optimal_value = clean_line.split(':')[1].strip()
                    else:
